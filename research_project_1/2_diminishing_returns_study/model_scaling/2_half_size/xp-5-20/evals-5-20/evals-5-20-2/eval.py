...
model = GPT()
model.eval()
model.load_state_dict(torch.load("/data/yb2618/Tiny-Language-Models-Framework/xperiments/xpgroup-5/xp-5-20/train-5-20/atmpt-2/checkpoints/best-model.pth", map_location = device))
model.to(device)
