...
model = GPT()
model.eval()
model.load_state_dict(torch.load("/data/yb2618/Tiny-Language-Models-Framework/xperiments/xpgroup-5/xp-5-25/train-5-25/checkpoints/best-model.pth", map_location = device))
model.to(device)
