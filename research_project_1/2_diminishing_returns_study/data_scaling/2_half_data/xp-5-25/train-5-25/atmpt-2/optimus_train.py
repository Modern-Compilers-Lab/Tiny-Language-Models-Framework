...
DDIR = "/data/yb2618/Tiny-Language-Models-Framework/datasets/dataset-45/datapreps-45/dataprep-45-1/data-dp-45-1/"
...
# Create the model
model = GPT()
model.load_state_dict(torch.load("../checkpoints/checkpoint_2.00.pth", map_location=device)) # Load the model from the checkpoint
