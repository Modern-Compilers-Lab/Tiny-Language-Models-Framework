...
model = GPT()
model.eval()
model.load_state_dict(torch.load("/data/yb2618/Tiny-Language-Models-Framework/xperiments/xpgroup-5/xp-5-26/train-5-26/checkpoints/checkpoint_2.00.pth", map_location = device))
model.to(device)
