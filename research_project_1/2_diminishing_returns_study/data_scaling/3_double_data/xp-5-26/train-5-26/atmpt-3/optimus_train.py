...
DDIR = "/data/yb2618/Tiny-Language-Models-Framework/datasets/dataset-44/datapreps-44/dataprep-44-1/data-dp-44-1/"
...
eval_iters = 1  # Number of iterations for evaluation
...
# Create the model
model = GPT()
model.load_state_dict(torch.load("../atmpt-2/checkpoints/checkpoint_0.60.pth", map_location=device))
...
optimizer.load_state_dict(torch.load("../atmpt-2/checkpoints/optimizer_0.60.pth", map_location=device))
