...
model = GPT()
model.eval()
model.load_state_dict(torch.load("/data/yb2618/Tiny-Language-Models-Framework/xperiments/xpgroup-5/xp-5-27/train-5-27/checkpoints/checkpoint_1.95.pth", map_location = device))
model.to(device)
