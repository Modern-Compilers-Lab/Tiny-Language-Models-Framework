...
with open("../../data-ds-23/direct_output_snippets.txt", "r") as f:
	data = f.read()
...
with open("data-dp-23-1/test.txt", 'w') as f:
	f.write(test_data)
del test_data
...
print(tpt.encode_to_file("data-dp-23-1/train.txt", "data-dp-23-1/train.bin", max_tokens = 16_525_778_545))

log("We generate the tokenized file of val.txt")
print(tpt.encode_to_file("data-dp-23-1/val.txt", "data-dp-23-1/val.bin"))

# Create the vocab_size.txt file
with open("data-dp-23-1/vocab_size.txt", "w") as f:
