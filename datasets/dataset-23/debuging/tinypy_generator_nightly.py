...
if __name__ == "__main__":
	...
	parser.add_argument("--random_state"			, default = '/data/yb2618/Tiny-Language-Models-Framework/datasets/dataset-23/debuging/frcg-random-states/random_state_2025-01-18_11-14-39.bin', help = "Path to python random state to be loaded if any")
	parser.add_argument("--nb_programs"				, default = 10000, help = "Number of programs to be generated")
	parser.add_argument("--output_file"				, default = "./debuging-data-ds-23/direct_output_snippets.txt", help = "Number of programs to be generated")
...
try:
	...
	while nb_generated_programs < nb_programs:
		...
		#######
		if r.findall(code):
			print(f'nb_generated_programs == {nb_generated_programs}')
			print(code)
			break
		#######
