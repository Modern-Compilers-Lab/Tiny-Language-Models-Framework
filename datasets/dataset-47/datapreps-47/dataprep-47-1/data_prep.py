...
with open("../../data-ds-47/traced_snippets.txt", "r") as f:
	data = f.read()
...
with open("data-dp-47-1/test.txt", 'w') as f:
	f.write(test_data)
del test_data
...
print(tpt.encode_to_file("data-dp-47-1/train.txt", "data-dp-47-1/train.bin"))

log("We generate the tokenized file of val.txt")
print(tpt.encode_to_file("data-dp-47-1/val.txt", "data-dp-47-1/val.bin"))

# Create the vocab_size.txt file
with open("data-dp-47-1/vocab_size.txt", "w") as f:
