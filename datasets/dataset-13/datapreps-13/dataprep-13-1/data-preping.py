...
with open("../../data-ds-13/data.txt", "r") as f:
	data = f.read()
...
with open("data-dp-13-1/train.txt", 'w') as f:
	f.write(train_data)
del train_data
...
with open("data-dp-13-1/val.txt", 'w') as f:
	f.write(val_data)
del val_data
...
with open("data-dp-13-1/test.txt", 'w') as f:
	f.write(test_data)
del test_data
...
print(tpt.encode_to_file("data-dp-13-1/train.txt", "data-dp-13-1/train.bin"))

log("We generate the tokenized file of val.txt")
print(tpt.encode_to_file("data-dp-13-1/val.txt", "data-dp-13-1/val.bin"))
