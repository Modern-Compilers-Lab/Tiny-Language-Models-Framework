...
if __name__ == "__main__":
	...
	parser.add_argument("--random_state"			, default = '/data/yb2618/Tiny-Language-Models-Framework/datasets/dataset-28/frcg-random-states/random_state_2025-01-19_14-40-49.bin', help = "Path to python random state to be loaded if any")
	parser.add_argument("--nb_programs"				, default = 750_000, help = "Number of programs to be generated")
	parser.add_argument("--output_file"				, default = "./data-ds-28/arccp_direct_output_snippets.txt", help = "Number of programs to be generated")
