...
if __name__ == "__main__":
	...
	parser.add_argument("--random_state"			, default = "./frcg-random-states/random_state_2025-02-08_20-13-41.bin", help = "Path to python random state to be loaded if any")
	parser.add_argument("--nb_programs"				, default = 1000, help = "Number of programs to be generated")
	parser.add_argument("--output_file"				, default = "./data-ds-34/direct_output_snippets.txt", help = "Number of programs to be generated")
