...
with open("../../data-ds-32/traced_snippets.txt", "r") as f:
	data = f.read()
...
with open("data-dp-32-1/train.txt", 'w') as f:
	f.write(train_data)
del train_data
...
with open("data-dp-32-1/val.txt", 'w') as f:
	f.write(val_data)
del val_data

log("creating the test_examples")
test_examples = examples[-25_000:]
...
with open("data-dp-32-1/test.txt", 'w') as f:
	f.write(test_data)
del test_data
...
print(tpt.encode_to_file("data-dp-32-1/train.txt", "data-dp-32-1/train.bin"))

log("We generate the tokenized file of val.txt")
print(tpt.encode_to_file("data-dp-32-1/val.txt", "data-dp-32-1/val.bin"))

# Create the vocab_size.txt file
with open("data-dp-32-1/vocab_size.txt", "w") as f:
