...
if __name__ == "__main__":
	...
	parser.add_argument("--random_state"			, default = '/data/yb2618/Tiny-Language-Models-Framework/datasets/dataset-23/frcg-random-states/random_state_2025-01-07_22-21-12.bin', help = "Path to python random state to be loaded if any")
	parser.add_argument("--nb_programs"				, default = 100, help = "Number of programs to be generated")
	parser.add_argument("--output_file"				, default = "./data-ds-32/direct_output_snippets.txt", help = "Number of programs to be generated")
