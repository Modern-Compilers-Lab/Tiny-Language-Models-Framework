...
if __name__ == "__main__":
	...
	parser.add_argument("--nb_programs"				, default = 250_000, help = "Number of programs to be generated")
	parser.add_argument("--output_file"				, default = "./data-ds-32-stage-1/aronly_direct_output_snippets.txt", help = "Number of programs to be generated")
	...
	with open('/data/yb2618/Tiny-Language-Models-Framework/datasets/dataset-28/data-ds-28/aronly_direct_output_snippets.txt', 'r') as f:
		old_data = f.read()
