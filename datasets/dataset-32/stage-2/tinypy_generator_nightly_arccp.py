...
WHILE_LOOP_ADD_UO_CONTROL_VARIABLE_INITIAL_VALUES 			= [i for i in range(100+1)]
WHILE_LOOP_ADD_UO_CONTROL_VARIABLE_INITIAL_VALUES_WEIGHTS 	= [1 for i in range(100+1)]
...
WHILE_LOOP_SUB_UO_CONTROL_VARIABLE_INITIAL_VALUES 			= [i for i in range(100+1)]
WHILE_LOOP_SUB_UO_CONTROL_VARIABLE_INITIAL_VALUES_WEIGHTS 	= [1 for i in range(100+1)]
...
WHILE_LOOP_FDIV_UO_CONTROL_VARIABLE_INITIAL_VALUES 			= [i for i in range(1, 100+1)]
WHILE_LOOP_FDIV_UO_CONTROL_VARIABLE_INITIAL_VALUES_WEIGHTS 	= [1 for i in range(1, 100+1)]
...
WHILE_LOOP_MUL_UO_CONTROL_VARIABLE_INITIAL_VALUES 			= [i for i in range(1, 100+1)]
WHILE_LOOP_MUL_UO_CONTROL_VARIABLE_INITIAL_VALUES_WEIGHTS	= [1 for i in range(1, 100+1)]
...
if __name__ == "__main__":
	...
	parser.add_argument("--nb_programs"				, default = 1_500_000, help = "Number of programs to be generated")
	parser.add_argument("--output_file"				, default = "./data-ds-32-stage-2/arccp_direct_output_snippets.txt", help = "Number of programs to be generated")
	...
	while nb_generated_programs < nb_programs:
		...
		if deduplicate:
			...
			if code_hash in hashes:
				nb_duplicates += 1
				if use_tqdm:
					pbar.set_description(f"ZeroDiv: {nb_zero_divisions:,} |Overflows: {nb_var_value_overflows:,} |NameErrors: {nb_name_errors:,} |Timeouts: {nb_timeouts:,}|Duplicates: {nb_duplicates:,}")
