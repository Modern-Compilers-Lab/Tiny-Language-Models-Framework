...
if __name__ == "__main__":
	...
	parser.add_argument("--nb_programs"				, default = 2_000_000, help = "Number of programs to be generated")
	parser.add_argument("--output_file"				, default = "./data-ds-32-stage-3/arccp_direct_output_snippets.txt", help = "Number of programs to be generated")
	...
	hashes = set()
	###################################
	# Filling the hash set with the arccp examples from dataset-30
	print("Filling the hash set with the arccp examples from dataset-30")
