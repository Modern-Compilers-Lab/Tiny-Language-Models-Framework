...
if __name__ == "__main__":
	...
	parser.add_argument("--nb_programs"				, default = 1_000_000, help = "Number of programs to be generated")
	parser.add_argument("--output_file"				, default = "./data-ds-32-stage-3/aronly_direct_output_snippets.txt", help = "Number of programs to be generated")
