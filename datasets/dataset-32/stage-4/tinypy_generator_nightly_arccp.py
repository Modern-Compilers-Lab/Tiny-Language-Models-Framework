...
if __name__ == "__main__":
	...
	parser.add_argument("--output_file"				, default = "./data-ds-32-stage-4/arccp_direct_output_snippets.txt", help = "Number of programs to be generated")
	...
	hashes = set()
	###################################
	# Filling the hash set with the arccp examples from dataset-31
	print("Filling the hash set with the arccp examples from dataset-31")
