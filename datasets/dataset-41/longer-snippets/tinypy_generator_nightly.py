...
if __name__ == "__main__":
	...
	parser.add_argument("--nb_programs"				, default = 8000, help = "Number of programs to be generated")
	parser.add_argument("--output_file"				, default = "./longer-snippets-data/direct_output_snippets.txt", help = "Number of programs to be generated")
