...
pytracing_generator(input_file_path="./more-while-iterations-data/direct_output_snippets.txt",
					output_file_path="./more-while-iterations-data/traced_snippets.txt"
					)
