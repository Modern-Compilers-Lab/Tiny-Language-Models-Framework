...
WHILE_LOOP_ADD_UO_NB_ITERS									= [i for i in range(11, 15+1)]
...
WHILE_LOOP_SUB_UO_NB_ITERS									= [i for i in range(11, 15+1)]

# WHILE LOOP PARAMETERS FOR DIV UPDATE OPERATOR
WHILE_LOOP_DIV_UO_CONTROL_VARIABLE_INITIAL_VALUES 			= [i for i in range(1, 999+1)]
WHILE_LOOP_DIV_UO_CONTROL_VARIABLE_INITIAL_VALUES_WEIGHTS 	= [1 for i in range(1, 999+1)]
...
WHILE_LOOP_MUL_UO_CONTROL_VARIABLE_INITIAL_VALUES 			= [i for i in range(1, 3+1)]
WHILE_LOOP_MUL_UO_CONTROL_VARIABLE_INITIAL_VALUES_WEIGHTS	= [1 for i in range(1, 3+1)]
WHILE_LOOP_MUL_UO_UPDATE_OPERAND_VALUES 					= [i for i in range(2, 2+1)]
WHILE_LOOP_MUL_UO_UPDATE_OPERAND_VALUES_WEIGHTS				= [1 for i in range(2, 2+1)]
WHILE_LOOP_MUL_UO_NB_ITERS									= [i for i in range(6, 8+1)]
...
if __name__ == "__main__":
	...
	parser.add_argument("--output_file"				, default = "./more-while-iterations-data/direct_output_snippets.txt", help = "Number of programs to be generated")
	...
	parser.add_argument("--log_interval"			, default = 10, help = "The number of code snippets generations before logging to the --log_file for monitoring progress")
