...
with open("../../data-ds-9/data.txt", "r") as f:
	data = f.read()
...
with open('data-dp-9-1/meta.pkl', 'wb') as f:
    pickle.dump(meta, f)
log("freeing its memory")
del meta
gc.collect()
...
with open("data-dp-9-1/train.txt", 'w') as f:
	f.write(train_data)
del train_data
...
with open("data-dp-9-1/val.txt", 'w') as f:
	f.write(val_data)
del val_data
...
with open("data-dp-9-1/test.txt", 'w') as f:
	f.write(test_data)
del test_data
...
with open("data-dp-9-1/meta.pkl", "rb") as f:
	meta = pickle.load(f)
stoi = meta["stoi"]
del meta
...
with open("data-dp-9-1/train.txt", "r") as f, open("data-dp-9-1/train.bin", "wb") as bin_file:
...
with open("data-dp-9-1/val.txt", "r") as f, open("data-dp-9-1/val.bin", "wb") as bin_file:
	chunk_size = 1024 * 1024 * 1000  # 1 GB
