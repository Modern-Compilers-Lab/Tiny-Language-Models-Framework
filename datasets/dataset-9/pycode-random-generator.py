...
if __name__ == "__main__":
	...
	parser.add_argument("--nb_programs", default = 90_000_000, help = "Number of programs to be generated")
	parser.add_argument("--output_file", default = "./data-ds-9/data.txt", help = "Number of programs to be generated")
