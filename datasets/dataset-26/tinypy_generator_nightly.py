...
if __name__ == "__main__":
	...
	parser.add_argument("--nb_programs"				, default = 61_000_000, help = "Number of programs to be generated")
	parser.add_argument("--output_file"				, default = "./data-ds-26/direct_output_snippets.txt", help = "Number of programs to be generated")
	...
	print('WARNING: this is the max_tokens version of the code generator')
	nb_generated_tokens = 0
	max_tokens = 17_000_000_000
...
try:
	...
	if use_tqdm:
		...
		pbar = tqdm(desc="Generation", total=max_tokens)
	...
	while nb_generated_tokens < max_tokens:
		...
		try:
			...
			nb_result_tokens = len(tpt.tokenize(result))
			nb_generated_tokens += nb_result_tokens
		...
		if use_tqdm:
			pbar.set_description(f"Programs: {nb_generated_programs} |ZeroDiv: {nb_zero_divisions:,} |Overflows: {nb_var_value_overflows:,} |NameErrors: {nb_name_errors:,} |Timeouts: {nb_timeouts:,}")
