...
if __name__ == "__main__":
	...
	parser.add_argument("--output_file"				, default = "./data-ds-stage-3/arccp_direct_output_snippets.txt", help = "Number of programs to be generated")
	...
	with open("/data/yb2618/Tiny-Language-Models-Framework/datasets/dataset-44/stage-3/data-ds-stage-3/arccp_direct_output_snippets.txt", "r") as f:
		data = f.read()
	old_examples = data.split("\n\n")[:-1]
	if use_tqdm:
		from tqdm import tqdm
