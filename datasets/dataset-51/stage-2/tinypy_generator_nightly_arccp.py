...
if __name__ == "__main__":
	...
	parser.add_argument("--nb_programs"				, default = 1_500_00, help = "Number of programs to be generated")
	parser.add_argument("--output_file"				, default = "./data-ds-51-stage-2/arccp_direct_output_snippets.txt", help = "Number of programs to be generated")
