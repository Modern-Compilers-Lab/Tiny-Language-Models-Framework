...
if __name__ == "__main__":
	...
	parser.add_argument("--nb_programs"				, default = 750_00, help = "Number of programs to be generated")
	parser.add_argument("--output_file"				, default = "./data-ds-51-stage-1/arccp_direct_output_snippets.txt", help = "Number of programs to be generated")
