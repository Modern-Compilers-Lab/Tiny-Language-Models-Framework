...
WHILE_LOOP_ADD_UO_UPDATE_OPERAND_VALUES_WEIGHTS 			= [1 for i in range(1, 20+1)]
WHILE_LOOP_ADD_UO_NB_ITERS									= [i for i in range(1, 5+1)]
...
WHILE_LOOP_SUB_UO_UPDATE_OPERAND_VALUES_WEIGHTS 			= [1 for i in range(1, 20+1)]
WHILE_LOOP_SUB_UO_NB_ITERS									= [i for i in range(1, 5+1)]
...
if __name__ == "__main__":
	...
	parser.add_argument("--output_file"				, default = "./data-ds-20/direct_output_snippets.txt", help = "Number of programs to be generated")
