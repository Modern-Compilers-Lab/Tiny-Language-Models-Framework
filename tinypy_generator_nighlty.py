...
if __name__ == "__main__":
	...
	parser.add_argument("--random_state"			, default = '/data/yb2618/Tiny-Language-Models-Framework/datasets/dataset-22/frcg-random-states/random_state_2025-01-06_20-07-47.bin', help = "Path to python random state to be loaded if any")
	parser.add_argument("--nb_programs"				, default = 10000, help = "Number of programs to be generated")
	parser.add_argument("--output_file"				, default = "./test_snippets.txt", help = "Number of programs to be generated")
