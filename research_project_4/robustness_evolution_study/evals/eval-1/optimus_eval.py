...
## On Greene
DDIR  = "/data/yb2618/Tiny-Language-Models-Framework/datasets/dataset-53/data/"
deviceid = 0
amp = True
...
model = GPT()
model.eval()
model.load_state_dict(torch.load("../../train/checkpoints/best-model.pth", map_location = device))
model.to(device)
...
with open("/data/yb2618/Tiny-Language-Models-Framework/datasets/dataset-55/data/traced_snippets.txt", "r") as f:
	test_data = f.read()
