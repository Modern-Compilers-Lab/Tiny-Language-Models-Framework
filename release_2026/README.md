...
- `release_2026.zip` file is a copy of `release_2026`, but it contains all the empty folders necessary to explain the different dataset generations, model trainings, and model evaluations conducted. 
