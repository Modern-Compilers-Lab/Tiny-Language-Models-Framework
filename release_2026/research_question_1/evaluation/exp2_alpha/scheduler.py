...
#on every architecture
gpus = [0,1,2,3]
data_path = "/data/ia2921/Tiny_language_model_framework/1Datasets/experiment_reboot/alpha_0.X/300m"
checkpoint_path = "/data/ia2921/Tiny_language_model_framework/2Training/experiment_reboot/exp2_alpha/checkpoints1"
ood_path = "/data/ia2921/Tiny_language_model_framework/1Datasets/experiment_reboot/alpha_0.X/OOD"
evaluation_script_path = ["/data/ia2921/Tiny_language_model_framework/3Evaluations/experiment_reboot/exp2_alpha/eval.py"]
checkpoints = [
    "checkpoint_0.03.pth",
    "checkpoint_0.07.pth",
    "checkpoint_0.10.pth",
...
def gpu_free(gpu_id, threshold=50000):  # MB
