...
data_path = "/data/ia2921/Tiny_language_model_framework/1Datasets/experiment_reboot/beta_0.X/300m"
checkpoint_path = "/data/ia2921/Tiny_language_model_framework/2Training/experiment_reboot/exp2_beta/checkpoints1"
ood_path = "/data/ia2921/Tiny_language_model_framework/1Datasets/experiment_reboot/beta_0.X/OOD"
evaluation_script_path = ["/data/ia2921/Tiny_language_model_framework/3Evaluations/experiment_reboot/exp2_beta/eval.py"]
checkpoints = [
    "checkpoint_0.03.pth",
    "checkpoint_0.07.pth",
    "checkpoint_0.10.pth",
