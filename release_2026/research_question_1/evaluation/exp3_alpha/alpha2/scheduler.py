...
#on every architecture
gpus = [2,3,4,5,6]
data_path = "/data/ia2921/Tiny_language_model_framework/1Datasets/experiment_reboot/alpha_2.X/data"
checkpoint_path = "/data/ia2921/Tiny_language_model_framework/2Training/experiment_reboot/exp3_alpha2/checkpoints1"
ood_path = "/data/ia2921/Tiny_language_model_framework/1Datasets/experiment_reboot/alpha_D"
evaluation_script_path = ["/data/ia2921/Tiny_language_model_framework/3Evaluations/experiment_reboot/exp3_alpha/alpha2/eval.py"]
# checkpoints = [
#  'checkpoint_0.10.pth',
#  'checkpoint_0.20.pth',
#  'checkpoint_0.30.pth',
...
test_datasets_titles = ["ID", "D7", "D8", "D9"]
