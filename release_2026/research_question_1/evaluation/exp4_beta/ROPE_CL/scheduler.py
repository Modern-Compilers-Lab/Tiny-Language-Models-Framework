...
checkpoint_path = "/data/ia2921/Tiny_language_model_framework/2Training/experiment_reboot/exp4_beta/exp4_beta_RoPE/checkpoints2"
ood_path = "/data/ia2921/Tiny_language_model_framework/1Datasets/experiment_reboot/beta_0.X/OOD"
evaluation_script_path = ["/data/ia2921/Tiny_language_model_framework/3Evaluations/experiment_reboot/exp4_beta/ROPE_CL/optimus_eval.py"]
# checkpoints = [
#  'checkpoint_0.10.pth',
#  'checkpoint_0.20.pth',
#  'checkpoint_0.30.pth',
...
tasks = ["deeper_nesting", "denser_snippets", "hidden_variables", "longer_snippets", "mixed_ops"]
...
test_datasets_titles = ["ID","OOD_Deeper","OOD_Denser","OOD_Hidden_variables","OOD_Longer_snippets","OOD_Mixed_ops"]
