...
#on every architecture
gpus = [3,4]
data_path = "/data/ia2921/Tiny_language_model_framework/1Datasets/experiment_reboot/beta_0.X/20mSP"
checkpoint_path = "/data/ia2921/Tiny_language_model_framework/2Training/experiment_reboot/exp4_beta/exp4_beta_Alibi_SP/checkpoints1"
ood_path = "/data/ia2921/Tiny_language_model_framework/1Datasets/experiment_reboot/beta_0.X/OOD"
evaluation_script_path = ["/data/ia2921/Tiny_language_model_framework/3Evaluations/experiment_reboot/exp4_beta/ALIBI_SP/eval.py"]
# checkpoints = [
#  'checkpoint_0.10.pth',
#  'checkpoint_0.20.pth',
#  'checkpoint_0.30.pth',
...
test_datasets_titles = ["ID","OOD_Mixed_ops"]
