...
#on every architecture
gpus = [0,1,2,3]
data_path = "/data/ia2921/Tiny_language_model_framework/1Datasets/experiment_reboot/beta_1.X/data"
checkpoint_path = "/data/ia2921/Tiny_language_model_framework/2Training/experiment_reboot/exp3_beta1/checkpoints1"
ood_path = "/data/ia2921/Tiny_language_model_framework/1Datasets/experiment_reboot/beta_D"
evaluation_script_path = ["/data/ia2921/Tiny_language_model_framework/3Evaluations/experiment_reboot/exp3_beta/beta1/eval.py"]
# checkpoints = [
#  'checkpoint_0.10.pth',
#  'checkpoint_0.20.pth',
#  'checkpoint_0.30.pth',
