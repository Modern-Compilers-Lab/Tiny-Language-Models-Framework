...
#on every architecture
gpus = [2,3,4,5,6]
data_path = "/data/ia2921/Tiny_language_model_framework/1Datasets/experiment_reboot/beta_2.X/data"
checkpoint_path = "/data/ia2921/Tiny_language_model_framework/2Training/experiment_reboot/exp3_beta2/checkpoints1"
ood_path = "/data/ia2921/Tiny_language_model_framework/1Datasets/experiment_reboot/beta_D"
evaluation_script_path = ["/data/ia2921/Tiny_language_model_framework/3Evaluations/experiment_reboot/exp3_beta/beta2/eval.py"]
# checkpoints = [
#  'checkpoint_0.10.pth',
#  'checkpoint_0.20.pth',
#  'checkpoint_0.30.pth',
