...
import numpy as np
import gc
from tinypy_code_tracer_SP_UNIGRAM_tokenizer import SPUnigramTokenizer
import os
...
output_folder_path = "./20mSP/"
os.makedirs(os.path.dirname(output_folder_path), exist_ok=True)
# Initialize the tokenizer
print("[*] Initializing the tokenizer ...")
tpt = SPUnigramTokenizer("/data/ia2921/Tiny_language_model_framework/1Datasets/experiment_reboot/alpha_0.X/20m/raw_ID.txt")

# Load the dataset of traced snippets
print("[*] Loading the dataset of traced snippets ...")
with open("/data/ia2921/Tiny_language_model_framework/1Datasets/experiment_reboot/alpha_0.X/20m/raw_ID.txt", "r") as f:
	data = f.read()
...
train_number = 20_000_000 - 10_000 - 2048
val_number = 10_000
test_number = 2048

# Creating the train dataset
print("[*] Creating the train dataset ...")
train_out_path = output_folder_path+"train.txt"
train_bin_out_path = output_folder_path+"train.bin"
...
val_out_path = output_folder_path+"val.txt"
val_bin_out_path = output_folder_path+"val.bin"
...
test_out_path = output_folder_path+"test.txt"
...
voc_size_path = output_folder_path+"vocab_size.txt"
with open(voc_size_path, "w") as f:
	f.write(str(tpt.vocab_size))