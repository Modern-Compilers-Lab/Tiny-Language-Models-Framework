        ...
        while generated_count < batch_size and consecutive_duplicates < max_consecutive_duplicates:
            try:
                ...
                if error_type is not None:
                    ...
                    if worker_tpg2.max_actual_nesting_depth>=3 and worker_tpg2.line_count<=worker_tpg2.max_line_count and worker_tpg2.if_count[0] <=2 and worker_tpg2.if_count[1] <=2 and worker_tpg2.if_count[2] <=2 and worker_tpg2.if_count[3] <=2 and worker_tpg2.if_count[4] <=2 and worker_tpg2.if_count[5] <=2 and worker_tpg2.if_count[6] <=2 and worker_tpg2.if_count[7] <=2 and worker_tpg2.if_count[8] <=2 and worker_tpg2.if_count[9] <=2 and worker_tpg2.if_count[10] <=2:
