...
# python3 tinypy_code_tracing_generator_parallel.py  --num-processes 64 --num-snippets 24000000
# python3 tinypy_code_tracing_generator_parallel.py  --num-processes 4 --num-snippets 1200
    ...
    def initiate_code(self):
        ...
        while self.context_stack.top().keywords_queue:
            ...
            if self.keyword == "ASSIGNMENT":
                ...
                u = random.random()
                if u < 0.15:
                    rhs = self.generate_number(self.max_digit_count,1)  
                    ...
                    if self.generated_variables:
                        if random.random() < 0.5:
                            ...
                            op1 =self.generate_number(self.max_digit_count,1)  
                        
                        if random.random() < 0.5:
                            op2 = random.choice(self.generated_variables)
                        else:
                            op2 =self.generate_number(self.max_digit_count,1)  
                    else:
                        op1 = self.generate_number(self.max_digit_count,1)  
                        op2 = self.generate_number(self.max_digit_count,1)   # it used to be only positive for some reason
...
if __name__ == "__main__":
    ...
    try:
        ...
        # print("practical rarity :",100*len(counter_len4)/((26**length)), " %")
