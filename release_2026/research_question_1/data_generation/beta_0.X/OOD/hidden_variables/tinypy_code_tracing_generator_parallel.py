...
class TinyPyGenerator2:
    ...
    def resetRand(self,index, arr, cte,worker_id=0):
        template = [[0, 0, 0, 0, 0], [174, 69, 53, 1, 676], [9300, 1759, 53, 1, 17576], [387184, 45699, 53, 1, 456976], [8841240, 1188139, 53, 1, 11881376]]
...
class ParallelTinyPyCodeTracingGenerator:
    def __init__(self, num_snippets):
        ...
        self.arr = [[0, 0, 0, 0, 0], [174, 69, 53, 1, 676], [9300, 1759, 53, 1, 17576], [387184, 45699, 53, 1, 456976], [8841240, 1188139, 53, 1, 11881376]]
        self.cte = 123456789
