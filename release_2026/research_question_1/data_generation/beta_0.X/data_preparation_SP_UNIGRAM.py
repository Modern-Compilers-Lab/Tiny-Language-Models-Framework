...
tpt = SPUnigramTokenizer("/data/ia2921/Tiny_language_model_framework/1Datasets/experiment_reboot/beta_0.X/20m/raw_ID.txt")

# Load the dataset of traced snippets
print("[*] Loading the dataset of traced snippets ...")
with open("/data/ia2921/Tiny_language_model_framework/1Datasets/experiment_reboot/beta_0.X/20m/raw_ID.txt", "r") as f:
	data = f.read()
