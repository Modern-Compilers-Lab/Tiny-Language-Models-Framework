...
folder_path = "./data_20_p/"
# Read the data from the source path
print('Reading data ...')
with open(folder_path+"raw_ID.txt", 'r') as f:
	data = f.read()
...
output_file = open(folder_path+"determinism_filtered_snippets.txt", "w")

# Open the file to write oversize snippets
oversize_snippets_file = open(folder_path+"oversize_snippets.txt", "w")
