...
tasks = []#["deeper_nesting", "denser_snippets", "hidden_numbers", "hidden_variables", "longer_snippets", "longer_variable_names", "mixed_ops"]
tests = []
...
for p in percentages : 
    ...
    tests.append(  ["/data/ia2921/Tiny_language_model_framework/1Datasets/simple_alpha/OOD/data_20_p/hidden_variables/data/test.txt"])
...
test_datasets_titles = ["OOD_Hidden_variables"]#,"OOD_Deeper","OOD_Denser","OOD_Hidden_numbers","OOD_Hidden_variables","OOD_Longer_snippets","OOD_Longer_variables","OOD_Mixed_ops"]
