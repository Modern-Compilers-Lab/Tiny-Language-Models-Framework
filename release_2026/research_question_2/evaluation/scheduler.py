...
for p in percentages : 
    ...
    tests.append(  ["/data/ia2921/Tiny_language_model_framework/1Datasets/simple_alpha/data_"+p+"_p/test.txt"] + partial)
...
test_datasets_titles = ["ID","OOD_Deeper","OOD_Denser","OOD_Hidden_numbers","OOD_Hidden_variables","OOD_Longer_snippets","OOD_Longer_variables","OOD_Mixed_ops"]
