...
# python3 tinypy_code_tracing_generator_parallel.py  --num-processes 1 --num-snippets 10000
...
class TinyPyGenerator2:
    ...
    def resetRand(self,index, arr, cte,worker_id=0):
        template = [[0, 0, 0, 0, 0], [512, 407, 53, 1, 676], [512, 10547, 53, 1, 17576], [158696, 274187, 53, 1, 456976], [2900552, 7128827, 53, 1, 11881376]]
...
class ParallelTinyPyCodeTracingGenerator:
    def __init__(self, num_snippets):
        ...
        self.arr = [[0, 0, 0, 0, 0], [512, 407, 53, 1, 676], [512, 10547, 53, 1, 17576], [158696, 274187, 53, 1, 456976], [2900552, 7128827, 53, 1, 11881376]]
        self.cte = 123456789
...
if __name__ == "__main__":
    ...
    for snippet in snippets:
        ...
        strings_len4 = re.findall(r'\b[a-z]{5}\b', snippet)
