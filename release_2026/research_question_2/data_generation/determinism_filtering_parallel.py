...
def main():
    folder_path = "/data/ia2921/Tiny_language_model_framework/1Datasets/simple_alpha/data/"
    ...
    # Configuration
    NUM_CORES = 60 # Leave a few cores free for system/IO
    BATCH_SIZE = 2000 # Higher batch size reduces Inter-Process Communication overhead
