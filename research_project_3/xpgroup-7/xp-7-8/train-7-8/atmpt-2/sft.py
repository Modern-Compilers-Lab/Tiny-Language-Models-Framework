...
train_sftrs = SFTRandomSampler("/data/yb2618/Tiny-Language-Models-Framework/xperiments/xpgroup-7/xp-7-8/train-7-8/ft-data/ft-train.txt", nb_train_examples, microbatch_size, block_size)
...
if master_process:
	...
	val_sftrs = SFTRandomSampler("/data/yb2618/Tiny-Language-Models-Framework/datasets/dataset-35/data-ds-35/val.txt", nb_eval_examples, eval_batch_size, block_size)
...
# Create the model
model = GPT()
model.load_state_dict(torch.load("/data/yb2618/Tiny-Language-Models-Framework/xperiments/xpgroup-7/xp-7-8/train-7-8/checkpoints/checkpoint_0.57.pth", map_location=device))
...
optimizer.load_state_dict(torch.load("/data/yb2618/Tiny-Language-Models-Framework/xperiments/xpgroup-7/xp-7-8/train-7-8/checkpoints/optimizer_0.57.pth", map_location=device))
