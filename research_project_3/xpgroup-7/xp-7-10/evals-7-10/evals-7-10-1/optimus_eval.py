...
model = GPT()
model.eval()
model.load_state_dict(torch.load("/data/yb2618/Tiny-Language-Models-Framework/xperiments/xpgroup-7/xp-7-10/train-7-10/checkpoints/best-model.pth", map_location = device))
model.to(device)
