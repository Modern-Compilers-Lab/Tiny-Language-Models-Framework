...
DDIR = "/scratch/yb2618/Tiny-Language-Models-Framework/datasets/dataset-31/datapreps-31/dataprep-31-1/data-dp-31-1/"
...
train_sftrs = SFTRandomSampler("/scratch/yb2618/Tiny-Language-Models-Framework/datasets/dataset-35/data-ds-35/train.txt", nb_train_examples, batch_size, block_size)
...
val_sftrs = SFTRandomSampler("/scratch/yb2618/Tiny-Language-Models-Framework/datasets/dataset-35/data-ds-35/val.txt", nb_eval_examples, eval_batch_size, block_size)
...
# Create the model
model = GPT()
model.load_state_dict(torch.load("/scratch/yb2618/Tiny-Language-Models-Framework/xperiments/xpgroup-5/xp-5-18/train-5-18/atmpt-2/checkpoints/best-model.pth", map_location=device))
