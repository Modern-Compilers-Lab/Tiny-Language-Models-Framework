...
nb_train_examples = 1_000_000
train_sftcs = SFTRandomSampler("./filtered_train.txt", nb_train_examples, batch_size, block_size, purge=False)
...
val_sftcs = SFTRandomSampler("./filtered_val.txt", nb_eval_examples, eval_batch_size, block_size, purge=False)
