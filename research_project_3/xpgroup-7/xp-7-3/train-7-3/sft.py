...
train_sftcs = SFTRandomSampler(DDIR+"val.txt", nb_train_examples, batch_size, block_size)
...
val_sftcs = SFTRandomSampler(DDIR+"test.txt", nb_eval_examples, eval_batch_size, block_size)
