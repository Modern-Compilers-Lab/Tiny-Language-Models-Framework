...
model = GPT()
model.eval()
model.load_state_dict(torch.load("/data/yb2618/Tiny-Language-Models-Framework/xperiments/xpgroup-7/xp-7-3/train-7-3/atmpt-2/checkpoints/checkpoint_0.7982129560685034.pth", map_location = device))
model.to(device)
