...
## On Greene
DDIR  = "/data/yb2618/Tiny-Language-Models-Framework/datasets/dataset-34/datapreps-34/dataprep-34-1/data-dp-34-1/"
deviceid = 1
amp = True
...
model = GPT()
model.eval()
model.load_state_dict(torch.load("/data/yb2618/Tiny-Language-Models-Framework/xperiments/xpgroup-7/xp-7-3/train-7-3/atmpt-3/checkpoints/checkpoint_1.0997070052383913.pth", map_location = device))
model.to(device)
