...
# Create the model
model = GPT()
model.load_state_dict(torch.load("../checkpoints/checkpoint_0.8999362553315409.pth", map_location=device))
...
optimizer.load_state_dict(torch.load("../checkpoints/optimizer_0.8999362553315409.pth", map_location=device))
