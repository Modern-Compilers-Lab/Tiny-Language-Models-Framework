...
# Create the model
model = GPT()
model.load_state_dict(torch.load("../atmpt-4/checkpoints/checkpoint_1.65.pth", map_location=device))
...
optimizer.load_state_dict(torch.load("../atmpt-4/checkpoints/optimizer_1.65.pth", map_location=device))
