...
# Create the model
model = GPT()
model.load_state_dict(torch.load("../atmpt-2/checkpoints/checkpoint_1.05.pth", map_location=device))
...
optimizer.load_state_dict(torch.load("../atmpt-2/checkpoints/optimizer_1.05.pth", map_location=device))
