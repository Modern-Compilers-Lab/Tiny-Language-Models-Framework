...
model = GPT()
model.eval()
model.load_state_dict(torch.load("/data/yb2618/Tiny-Language-Models-Framework/xperiments/xpgroup-10/xp-10-2/train-10-2/atmpt-5/checkpoints/best-model.pth", map_location = device))
model.to(device)
