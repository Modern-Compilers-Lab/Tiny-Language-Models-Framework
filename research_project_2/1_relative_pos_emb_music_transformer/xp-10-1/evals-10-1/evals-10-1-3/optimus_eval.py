...
n_embd = 448	  # Embedding dimension for 120M
...
model = GPT()
model.eval()
model.load_state_dict(torch.load("/data/yb2618/Tiny-Language-Models-Framework/xperiments/xpgroup-10/xp-10-1/train-10-1/atmpt-5/checkpoints/best-model.pth", map_location = device))
model.to(device)
