...
learning_rate = 1e-4 	# Initial Learning rate value
decay_lr = True
...
# Create the model
model = GPT()
model.load_state_dict(torch.load("../atmpt-2/checkpoints/checkpoint_1.80.pth", map_location=device))
...
optimizer.load_state_dict(torch.load("../atmpt-2/checkpoints/optimizer_1.80.pth", map_location=device))
