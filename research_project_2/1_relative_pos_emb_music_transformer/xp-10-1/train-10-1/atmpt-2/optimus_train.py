...
# Create the model
model = GPT()
model.load_state_dict(torch.load("../checkpoints/checkpoint_1.60.pth", map_location=device))
...
optimizer.load_state_dict(torch.load("../checkpoints/optimizer_1.60.pth", map_location=device))
