...
## On Greene
DDIR  = "../../../../datasets/dataset-9/datapreps-9/dataprep-9-1/data-dp-9-1/"
deviceid = 5
...
model = GPT()
model.eval()
model.load_state_dict(torch.load("/data/hb3020/github-repo/Tiny-Language-Models-Framework/xperiments/xpgroup-2/xp-2-22/train-2-22/checkpoints/best-model.pth"))
model.to(device)
