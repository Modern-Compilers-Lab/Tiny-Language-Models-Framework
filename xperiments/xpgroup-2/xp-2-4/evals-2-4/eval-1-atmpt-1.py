...
model = GPT()
model.eval()
model.load_state_dict(torch.load("/data/hb3020/github-repo/Tiny-Language-Models-Framework/xperiments/xpgroup-2/xp-2-4/train-2-4/checkpoints/best-model.pth"))
model.to(device)
