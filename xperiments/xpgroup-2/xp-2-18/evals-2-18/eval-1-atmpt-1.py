...
## On Greene
DDIR  = "../../../../datasets/dataset-8/datapreps-8/dataprep-8-1/data-dp-8-1/"
deviceid = 2
...
model = GPT()
model.eval()
model.load_state_dict(torch.load("/data/hb3020/github-repo/Tiny-Language-Models-Framework/xperiments/xpgroup-2/xp-2-18/train-2-18/checkpoints/best-model.pth"))
model.to(device)
