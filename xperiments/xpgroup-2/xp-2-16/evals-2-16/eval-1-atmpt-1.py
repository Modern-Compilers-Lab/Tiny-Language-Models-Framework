...
## On Greene
DDIR  = "../../../../datasets/dataset-6/datapreps-6/dataprep-6-1/data-dp-6-1/"
deviceid = 6
...
n_embd = 648	  # Embedding dimension for 120M
...
model = GPT()
model.eval()
model.load_state_dict(torch.load("/data/hb3020/github-repo/Tiny-Language-Models-Framework/xperiments/xpgroup-2/xp-2-16/train-2-16/checkpoints/best-model.pth"))
model.to(device)
