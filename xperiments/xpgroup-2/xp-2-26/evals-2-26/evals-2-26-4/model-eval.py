...
## On Greene
DDIR  = "../../../../../datasets/dataset-11/datapreps-11/dataprep-11-1/data-dp-11-1/"
deviceid = 6
...
n_embd = 272  # Embedding dimension for 120M
...
model = GPT()
model.eval()
model.load_state_dict(torch.load("/data/hb3020/github-repo/Tiny-Language-Models-Framework/xperiments/xpgroup-2/xp-2-26/train-2-26/checkpoints/best-model.pth"))
model.to(device)


## Reading the test data
log("Reading the test data")
with open("./test_with_output.txt", "r") as f:
	test_data = f.read()
