...
n_embd = 416	  # Embedding dimension for 120M
...
model = GPT()
model.eval()
model.load_state_dict(torch.load("/data/hb3020/github-repo/Tiny-Language-Models-Framework/xperiments/xpgroup-2/xp-2-19/train-2-19/checkpoints/best-model.pth"))
model.to(device)
