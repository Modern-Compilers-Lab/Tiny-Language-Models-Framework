...
run = neptune.init_run(
	...
	tags = ["30M-model", "~30M-code-snippets", "2Depth", "1Subblocks", "WithDivisionMultiplicationModulo"],
	description = "We train from scratch the 30M parameters model on dataset-5 which has ~30M snippets with depth 2, subblocks 1, with division multipilication modulo operators",
