...
## On Greene
DDIR  = "../../../../../datasets/dataset-3/datapreps/dataprep-1/data/"
deviceid = 1
...
n_embd = 792	  # Embedding dimension for 120M
...
model = GPT()
model.eval()
model.load_state_dict(torch.load("../../train/checkpoints/best-model.pth"))
model.to(device)
