...
## On Greene
DDIR  = "../../../../../datasets/dataset-32/datapreps-32/dataprep-32-1/data-dp-32-1/"
deviceid = 5
amp = True
...
model = GPT()
model.eval()
model.load_state_dict(torch.load("/data/yb2618/Tiny-Language-Models-Framework/xperiments/xpgroup-5/xp-5-19/train-5-19/checkpoints/checkpoint_2.00.pth", map_location = device))
model.to(device)
...
with open("./traced_30PS_chatGPT_normalized.txt", "r") as f:
	test_data = f.read()
