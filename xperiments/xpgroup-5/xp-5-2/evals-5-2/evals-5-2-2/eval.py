...
## On Greene
DDIR  = "../../../../../datasets/dataset-17/datapreps-17/dataprep-17-1/data-dp-17-1/"
deviceid = 2
...
n_embd = 180	  # Embedding dimension for 120M
...
model = GPT()
model.eval()
model.load_state_dict(torch.load("../../train-5-2/checkpoints/best-model.pth"))
model.to(device)
