...
model = GPT()
model.eval()
model.load_state_dict(torch.load("/data/yb2618/Tiny-Language-Models-Framework/xperiments/xpgroup-5/xp-5-18/train-5-18/checkpoints/checkpoint_1.9997824117664174.pth", map_location = device))
model.to(device)
