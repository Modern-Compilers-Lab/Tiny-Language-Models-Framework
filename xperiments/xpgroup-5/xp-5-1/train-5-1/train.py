...
config 		= OmegaConf.load("../xp-5-1.conf")
XP 			= config['neptune-id']
DDIR 		= "/data/yb2618/Tiny-Language-Models-Framework/datasets/dataset-18/datapreps-18/dataprep-18-1/data-dp-18-1/"
deviceid 	= 4
...
run["arch-hyperparams/n_embd"] 		= n_embd 		= 128	# Embedding dimension
