...
## On Greene
DDIR  = "../../../../../datasets/dataset-20/datapreps-20/dataprep-20-1/data-dp-20-1/"
deviceid = 7
...
n_embd = 192	  # Embedding dimension for 120M
...
model = GPT()
model.eval()
model.load_state_dict(torch.load("../../train-5-4/checkpoints/best-model.pth"))
model.to(device)
