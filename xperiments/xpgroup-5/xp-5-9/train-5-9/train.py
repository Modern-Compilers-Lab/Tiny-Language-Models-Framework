...
config 		= OmegaConf.load("../xp-5-9.conf")
XP 			= config['neptune-id']
DDIR 		= "/data/yb2618/Tiny-Language-Models-Framework/datasets/dataset-24/datapreps-24/dataprep-24-1/data-dp-24-1/"
deviceid 	= 0
...
run["arch-hyperparams/n_embd"] 		= n_embd 		= 320	# Embedding dimension
