...
n_layer = 21    # Number of transformer blocks
...
model = GPT()
model.eval()
model.load_state_dict(torch.load("/data/yb2618/Tiny-Language-Models-Framework/xperiments/xpgroup-5/xp-5-15/train-5-15/checkpoints/checkpoint_depth_21.pth", map_location = device))
model.to(device)
