...
DDIR = "/data/yb2618/Tiny-Language-Models-Framework/datasets/dataset-21/datapreps-21/dataprep-21-1/data-dp-21-1/"
...
batch_size = 640   	# Batch size for training
...
# If master process, prepare the evaluation facilities
if master_process:
...
if master_process:
	...
	log(f'INITIAL LOSS: train loss {last_losses["train"]:.10f} | val loss {last_losses["val"]:.10f}')
	deltatimes = 0
...
for iter in range(max_iters):
	...
	if (iter+1) % eval_interval == 0 and master_process:
