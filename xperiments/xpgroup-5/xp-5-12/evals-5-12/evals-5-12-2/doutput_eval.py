...
## On Greene
DDIR  = "../../../../../datasets/dataset-23/datapreps-23/dataprep-23-1/data-dp-23-1/"
deviceid = 0
...
model = GPT()
model.eval()
model.load_state_dict(torch.load("../../train-5-12/checkpoints/best-model.pth", map_location=device))
model.to(device)


## Reading the test data
log("Reading the test data")
with open("./doutput_30PS_chatGPT_normalized.txt", "r") as f:
	test_data = f.read()
...
examples = examples[:11] + examples[12:]
