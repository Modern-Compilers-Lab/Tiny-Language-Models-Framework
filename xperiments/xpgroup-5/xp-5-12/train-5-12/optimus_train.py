...
DDIR = "/data/yb2618/Tiny-Language-Models-Framework/datasets/dataset-23/datapreps-23/dataprep-23-1/data-dp-23-1/"
...
for iter in range(start_iter, max_iters):
	...
	if master_process:
		...
		if loop_warmup_iters <= loop_max_warmup_iters:
			log(f"WARMUP LOOP TIME: {present-past}")
