...
config 		= OmegaConf.load("../xp-5-3.conf")
XP 			= config['neptune-id']
DDIR 		= "/data/yb2618/Tiny-Language-Models-Framework/datasets/dataset-19/datapreps-19/dataprep-19-1/data-dp-19-1/"
deviceid 	= 6
...
run["arch-hyperparams/block_size"] 	= block_size 	= 512 	# Maximum context length
run["arch-hyperparams/n_embd"] 		= n_embd 		= 192	# Embedding dimension
